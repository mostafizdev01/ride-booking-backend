...
const sslPaymentInit = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        throw new AppHelpers_1.default(http_status_codes_1.default.BAD_REQUEST, error.message);
    }
});
const validatePayment = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        console.log(error);
        throw new AppHelpers_1.default(401, `Payment Validation Error, ${error.message}`);
    }
});
exports.SSLService = {
    sslPaymentInit,
