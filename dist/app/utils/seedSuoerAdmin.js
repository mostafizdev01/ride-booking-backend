...
const seedSuoerAdmin = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const isSuperAdminEixist = yield user_model_1.User.findOne({ email: env_1.envVars.SUPER_ADMIN_EMAIL });
...
exports.seedSuoerAdmin = seedSuoerAdmin;
